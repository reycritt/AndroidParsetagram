...
- [x] Locked the "Compose" fragment to avoid duplicate posts and post spam

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/reycritt/AndroidParsetagram/blob/master/Part%202.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

## Notes

- Had issues with the recycler view not properly loading posts (some posts would be replaced with duplicates); this may have been caused due to an unprotected "Compose" fragment
